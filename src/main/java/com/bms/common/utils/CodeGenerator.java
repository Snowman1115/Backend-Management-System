    ...
    private static void generate() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/bms?serverTimezone=Asia/Kuala_Lumpur","root","1234")
                ...
                //            .enableSwagger() // Enable Swagger
                            .fileOverride() // Enable Overwrite C:\Users\chanh\Desktop\Backend-Management-System\bms-back\src\main\java\com\bms
                            .outputDir("C:\\Users\\chanh\\Desktop\\Backend-Management-System\\bms-back\\src\\main\\java\\"); // Export Directory
                })
                .packageConfig(builder -> {
                    builder.parent("com.bms") // Parent Package
                            .moduleName("") // Parent Module
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "C:\\Users\\chanh\\Desktop\\Backend-Management-System\\bms-back\\src\\main\\resources\\mapper")); // mapperXml generate Path
                })
